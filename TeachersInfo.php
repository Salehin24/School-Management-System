...
<br>
<table  class="co_curricular" cellspacing="5" cellpadding="10">
            <caption> Teacher's InFo Table </caption>

        <thead style="background-color:green; border-radius: 10px;">
