...
<table class="table" align="center" border="0" cellspacing="5" cellpadding="10px" width="100%">
        ...
        <td width="100px" class="box"  > <a href="#" target="_blank"> Home</a></td>
        <td width="100px" class="box" ><a href="co_curricular.html"> Co-curricular</a></td>


        <td width="100px" class="box"  > <a href="#" target="_blank">Attendance</a></td>
        <td width="100px" class="box" ><a href="#" target="_blank"> Class Routin </a></td>
        <td width="100px" class="box" ><a href="find-result.php">Results</a></td>
        <td width="100px" class="box" ><a href="#" target="_blank">Teacher's Info </a> </td>
        <td width="100px" class="box" ><a href="#" target="_blank">Gallery</a></td>

        <td width="100px" class="box" ><a href="main.php"> Contact </a></td>
        ...
        <td colspan="2" valign="top" width="25%" >
            ...
            <table border="0" class="adm" cellspacing="10" cellpadding="5">
                ...
                <marquee direction="left" Scrolldelay="150" ><strong>
                    ****The "Inter-School Game Competition-2018" will be held on 26 March 2018,If you interested to join the game; Please contact with your physical teacher ****
                    </strong>
               </marquee>
                <br>
                <br>
                <br>
                <marquee direction="left" Scrolldelay="150" ><strong>
                ****Admission going on 01 April 2018 at class Nine**** 
                </strong>
               </marquee>
                <br>
...
<!-- Right side bar start-->
    ...
    <td colspan="2" valign="top" width="25%" class="rightbar" >
            ...
            <table border="0" class="adm" cellspacing="3" cellpadding="5">
                ...
                <br>
                <li ><a href="student_login/index.php"><strong>Student LogIn</strong></a> </li>
 ...
 <tr><!-- footer tr start -->
           ...
           <table style="width: 100%; color: #222222;">
                     <tr>
                        <td style="text-align: left;padding-left: 15px;">Copyright 2018 @ <a style="text-decoration: none;" href="#" target="_blank">PHP "Student Management System" Project Group &trade;</a>. All Rights Reserved.</td>
                        <td style="text-align: right;padding-right:15px;"><a href=" https://www.facebook.com/kabirbd.tk" style="   text-decoration: none;" target="_blank" > <dfn> Developed by S.Kabir</a></dfn></td>
                    </tr>
                 </table>
